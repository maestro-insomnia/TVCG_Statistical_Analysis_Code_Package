# Run Example 4 using the 2 x 6 within-subjects synthetic dataset (ANOVA + ART coverage).
...
run_analysis(file.path(script_dir, "configs", "Config_Example_4_Within_Subjects.R"))
