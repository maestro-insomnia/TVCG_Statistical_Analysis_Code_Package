...
# include_in_correlation: TRUE includes the variable in correlation analysis.
  ...
  analysis = list(
    ...
    # Multiplicity adjustment used for ANOVA/ART-ANOVA pairwise comparisons
    # and interaction contrasts. Default: Bonferroni. Common alternatives
    # include "holm", "hochberg", "hommel", "BH", "BY", "tukey",
    # "sidak", "scheffe", "mvt", and "none". The selected method is
    # reported dynamically in the Excel workbook and figures PDF.
  ...
  correlation = list(
    ...
    # Multiplicity adjustment applied together across all successfully tested
    # correlation pairs. Default: Benjamini-Hochberg (BH; also called FDR).
    # Methods supported by stats::p.adjust() may be used, including "holm",
    # "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr", and "none".
    # "fdr" is normalized to the equivalent "BH" method. The selected method
    # is reported dynamically in the Excel workbook and correlation PDF page.
    p_adjust_method = "BH",
