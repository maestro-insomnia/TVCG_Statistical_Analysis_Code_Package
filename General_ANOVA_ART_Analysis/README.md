...
- Structured Excel output with analysis results, diagnostics, and column definitions.
- Multi-page PDF output with main-effect plots, interaction plots, significance annotations, and an optional correlation heatmap.
...
Correlation p values are adjusted using the configured multiplicity correction.
...
When correlation analysis is enabled, the correlation heatmap is appended to the PDF.
